...
type NftAirdropOperation struct {
	...
	Type       int       `gorm:"column:type;type:tinyint(1);comment:操作类型;NOT NULL" json:"type"`
	Parameter  string    `gorm:"column:parameter;type:json;comment:操作参数;NOT NULL" json:"parameter"`
...
func (m *NftAirdropOperation) TableName() string {
	return "nft_airdrop_operation"
}

...
import (
	"airmart-core/config"
	"airmart-core/middlewares/elasticsearch"
	"airmart-core/middlewares/jaeger"
	"airmart-core/middlewares/kafka"
	logger "airmart-core/middlewares/logger"
	"airmart-core/middlewares/mysql"
	"airmart-core/middlewares/redis"
